...
const Sidebar = ({ page }) => {
  ...
  const menuItems = [
    ...
    },
    {
      ...
      active: page === "product-list",
    },
    {
      label: "Manage Discount",
      href: "/cms/discount/list",
      icon: (
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-4 mr-3">
            ...
            <li key={index} className="mb-2">
              <a
                ...
                className={`py-3 px-3 text-sm rounded-md flex items-center ${
                  item.active ? "bg-black text-white" : "hover:bg-gray-200"
                }`}
              >
                {item.icon}
                {item.label}
