...
function HomePage() {
  ...
  return (
    <div className="font-sans text-center">
      ...
      <main>
        <section ref={section1Ref} className={`my-16 mx-4 lg:mx-16 lg:my-32 ${section1InView ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <section ref={section2Ref} className={`flex items-center justify-center my-8 ${section2InView ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <section ref={section3Ref} className={`my-32 mx-4 lg:mx-16 lg:my-48 ${section3InView ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <section ref={section4Ref} className={`my-32 mx-4 lg:mx-16 lg:my-48 ${section4InView ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <section ref={section5Ref} className={`my-32 mx-4 lg:mx-16 lg:my-48 ${section5InView ? 'opacity-100' : 'opacity-0'}`}>
        ...
        <section ref={section6Ref} className={`my-32 mx-4 lg:mx-16 lg:my-48 bg-gray-100 py-24 ${section6InView ? 'opacity-100' : 'opacity-0'}`}>
