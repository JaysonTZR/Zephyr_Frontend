          ...
          <div className="container mx-auto flex flex-col lg:flex-row lg:space-x-2">
            <div className="bg-white rounded-md flex-grow">
              ...
              <div className="grid grid-cols-10 gap-6 border-b pb-4">
                ...
                <div className="col-span-2 font-semibold text-center uppercase">Total</div>
              </div>
            ...
            <div className="flex flex-col lg:w-1/3 items-start">
              <div className="font-semibold text-center uppercase ml-7">Discount Codes</div>
              <div className="bg-white px-6 py-4 rounded-md w-full">
                ...
                <div className="text-left px-8 py-8 mt-16" style={{ backgroundColor: '#f3f2ee' }}>
                  <p className="text-lg font-medium">CART TOTAL</p>
                  <div className="text-zinc-500 mt-5 flex justify-between">
                    Subtotal{" "}
                    <span className="font-semibold text-lg text-red-600">$169.50</span>
                  </div>
                  <div className="text-zinc-500 mt-4 flex justify-between">
                    Total{" "}
                    <span className="font-semibold text-lg text-red-600">$169.50</span>
                  </div>
                  <button onClick={handleCheckout} className="bg-black text-white w-full px-6 py-3 mt-8 uppercase tracking-widest font-semibold text-sm hover:bg-gray-800">
                    Proceed to Checkout
                  </button>
                </div>
              </div>
