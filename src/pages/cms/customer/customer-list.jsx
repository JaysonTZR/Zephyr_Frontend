            ...
            <div className="bg-white shadow-md rounded-lg">
              ...
              <div className="flex justify-between items-center p-6">
                ...
                <div className="flex space-x-4">
                  ...
                  <button onClick={addCustomer} className=" text-white w-36 h-9 rounded-md text-sm focus:outline-none hover:bg-zinc-700 bg-black flex justify-center items-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="size-5 mr-2">
              ...
              {/* Table Section */}
              <Table tableHeader={tableHeader} tableData={filteredData} editPath={"/cms/customer/edit"} deletePath={true}/>
            </div>
          </main>
          <Footer />
        </div>
